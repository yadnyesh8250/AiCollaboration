...
export default function AuthLayout() {
  return (
    <div className="flex min-h-screen w-screen bg-black overflow-x-hidden selection:bg-primary/20 selection:text-white">
      {/* Left Column: Premium Interactive Product Showcase (Desktop Only) */}
      <div className="hidden lg:block lg:w-1/2 h-screen sticky top-0 border-r border-zinc-950">
        <ProductShowcase />
      </div>

      {/* Right Column: Interaction Form Card */}
      <div className="w-full lg:w-1/2 flex items-center justify-center min-h-screen p-6 relative bg-[#030303]">
